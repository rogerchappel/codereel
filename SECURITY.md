...
Replace this section with the supported versions for `codereel`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `codereel` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in codereel.
